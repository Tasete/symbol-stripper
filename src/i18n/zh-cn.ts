...
export const zhCN: Record<string, string> = {
	...
	'presets.guide.charMode.label': '字符模式',
	'presets.guide.charMode.desc': '：逐个剔除指定字符。如输入 ',
	'presets.guide.charMode.code': '0123456789',
	'presets.guide.charMode.suffix': ' 将剔除所有数字',
	'presets.guide.regexMode.label': '正则模式',
	'presets.guide.regexMode.desc': '：按正则表达式匹配剔除。如输入 ',
	'presets.guide.regexMode.code': '\\s+',
	'presets.guide.regexMode.suffix': ' 将剔除所有连续空白',
