...
export const en: Record<string, string> = {
	...
	'presets.guide.charMode.label': 'Char Mode',
	'presets.guide.charMode.desc': ': Strip specified characters one by one. e.g. ',
	'presets.guide.charMode.code': '0123456789',
	'presets.guide.charMode.suffix': ' strips all digits',
	'presets.guide.regexMode.label': 'Regex Mode',
	'presets.guide.regexMode.desc': ': Strip by regex pattern matching. e.g. ',
	'presets.guide.regexMode.code': '\\s+',
	'presets.guide.regexMode.suffix': ' strips all consecutive whitespace',
